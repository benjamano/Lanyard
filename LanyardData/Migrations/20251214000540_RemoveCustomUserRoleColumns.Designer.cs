...
namespace LanyardApp.Migrations
{
    ...
    [Migration("20251214000540_RemoveCustomUserRoleColumns")]
    partial class RemoveCustomUserRoleColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LanyardData.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("LanyardData.Models.Playlist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("LanyardData.Models.PlaylistSongMember", b =>
                {
            ...
            modelBuilder.Entity("LanyardData.Models.Song", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LanyardData.Models.ApplicationRole", b =>
                {
                    b.HasOne("LanyardData.Models.UserProfile", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("LanyardData.Models.PlaylistSongMember", b =>
                {
                    ...
                    b.HasOne("LanyardData.Models.Playlist", "Playlist")
                        .WithMany()
                        .HasForeignKey("PlaylistId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LanyardData.Models.Song", "Song")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("LanyardData.Models.ApplicationRole", null)
                        .WithMany()
